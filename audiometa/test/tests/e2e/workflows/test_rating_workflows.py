...
class TestRatingWorkflows:
    ...
    def test_metadata_with_different_rating_normalizations(self):
        ...
        with temp_file_with_metadata(initial_metadata, "mp3") as test_file_path:
            ...
            update_metadata(
                test_file_path, test_metadata_100, normalized_rating_max_value=100, metadata_format=MetadataFormat.ID3V2
            )
            ...
            update_metadata(
                test_file_path, test_metadata_255, normalized_rating_max_value=255, metadata_format=MetadataFormat.ID3V2
            )
    ...
    def test_rating_deletion_workflow(self):
        ...
        with temp_file_with_metadata(initial_metadata, "mp3") as test_file_path:
            ...
            update_metadata(
                test_file_path, rating_deletion, normalized_rating_max_value=100, metadata_format=MetadataFormat.ID3V2
            )
            ...
            update_metadata(
                test_file_path, rating_deletion, normalized_rating_max_value=255, metadata_format=MetadataFormat.ID3V2
            )
