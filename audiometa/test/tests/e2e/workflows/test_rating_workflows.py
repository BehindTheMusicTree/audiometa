...
class TestRatingWorkflows:
    ...
    def test_metadata_with_different_rating_normalizations(self):
        ...
        with temp_file_with_metadata(initial_metadata, "mp3") as test_file_path:
            ...
            update_metadata(test_file_path, test_metadata_100, normalized_rating_max_value=100, metadata_format=MetadataFormat.ID3V2)
    
            metadata_100 = get_unified_metadata(test_file_path, normalized_rating_max_value=100)
            ...
            update_metadata(test_file_path, test_metadata_255, normalized_rating_max_value=255, metadata_format=MetadataFormat.ID3V2)
    
            metadata_255 = get_unified_metadata(test_file_path, normalized_rating_max_value=255)
    ...
    def test_rating_deletion_workflow(self):
        ...
        with temp_file_with_metadata(initial_metadata, "mp3") as test_file_path:
            ...
            update_metadata(test_file_path, rating_metadata_100, normalized_rating_max_value=100, metadata_format=MetadataFormat.ID3V2)
            
            # 2. Verify rating was added
            metadata_with_rating = get_unified_metadata(test_file_path, normalized_rating_max_value=100)
            ...
            update_metadata(test_file_path, rating_deletion, normalized_rating_max_value=100, metadata_format=MetadataFormat.ID3V2)
            
            # 4. Verify rating was deleted
            metadata_after_deletion = get_unified_metadata(test_file_path, normalized_rating_max_value=100)
            ...
            update_metadata(test_file_path, rating_metadata_255, normalized_rating_max_value=255, metadata_format=MetadataFormat.ID3V2)
            
            # 6. Verify rating was added with 255 scale
            metadata_with_rating_255 = get_unified_metadata(test_file_path, normalized_rating_max_value=255)
            assert metadata_with_rating_255.get(UnifiedMetadataKey.RATING) == 204
            
            # 7. Delete rating with 255 scale
            update_metadata(test_file_path, rating_deletion, normalized_rating_max_value=255, metadata_format=MetadataFormat.ID3V2)
            
            # 8. Verify rating was deleted
            final_metadata = get_unified_metadata(test_file_path, normalized_rating_max_value=255)
    ...
    def test_complete_rating_cleanup_workflow(self):
        ...
        initial_metadata = {
            "title": "Complete Rating Cleanup",
            "artist": "Complete Rating Artist"
        }
        ...
        with temp_file_with_metadata(initial_metadata, "mp3") as test_file_path:
            ...
            update_metadata(test_file_path, comprehensive_metadata, normalized_rating_max_value=100)
            ...
            cleaned_metadata = get_unified_metadata(test_file_path, normalized_rating_max_value=100)
