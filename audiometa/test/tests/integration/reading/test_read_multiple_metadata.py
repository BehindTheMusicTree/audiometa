...
class TestMultipleMetadata:
    ...
    def test_id3v1(self):
        with temp_file_with_metadata({}, "mp3") as test_file_path:
            ...
            ID3v1MetadataSetter.set_album(test_file_path, "ID3v1 Album")

            merged_metadata = get_unified_metadata(test_file_path)
    ...
    def test_id3v2_3(self):
        with temp_file_with_metadata({}, "id3v2.3") as test_file_path:
            ...
            ID3v2MetadataSetter.set_title(test_file_path, "ID3v2.3 Title", version="2.3")
            ID3v2MetadataSetter.set_artists(test_file_path, "ID3v2.3 Artist", version="2.3")
            ID3v2MetadataSetter.set_album(test_file_path, "ID3v2.3 Album", version="2.3")
    ...
    def test_id3v2_4(self):
        with temp_file_with_metadata({}, "id3v2.4") as test_file_path:
            ...
            ID3v2MetadataSetter.set_title(test_file_path, "ID3v2.4 Title", version="2.4")
            ID3v2MetadataSetter.set_artists(test_file_path, "ID3v2.4 Artist", version="2.4")
            ID3v2MetadataSetter.set_album(test_file_path, "ID3v2.4 Album", version="2.4")
    ...
    def test_riff(self):
        with temp_file_with_metadata({}, "wav") as test_file_path:
            ...
            RIFFMetadataSetter.set_title(test_file_path, "RIFF Title")
            RIFFMetadataSetter.set_artist(test_file_path, "RIFF Artist")
            RIFFMetadataSetter.set_album(test_file_path, "RIFF Album")
    ...
    def test_vorbis(self):
        with temp_file_with_metadata({}, "flac") as test_file_path:
            ...
            VorbisMetadataSetter.set_artist(test_file_path, "Vorbis Artist")
            VorbisMetadataSetter.set_album(test_file_path, "Vorbis Album")
