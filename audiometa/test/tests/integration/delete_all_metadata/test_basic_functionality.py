...
class TestDeleteAllMetadataBasic:
    ...
    def test_delete_all_metadata_id3v2_version_specific(self):
        ...
        with temp_file_with_metadata(test_metadata, "mp3") as test_file_path:
            ...
            result = delete_all_metadata(test_file_path, id3v2_version=(2, 3, 0))
            assert result is True
    ...
    def test_delete_all_metadata_preserves_audio_data(self):
        ...
        with temp_file_with_metadata(test_metadata, "mp3") as test_file_path:
            ...
            with_metadata_size = test_file_path.stat().st_size
            ...
            after_deletion_size = test_file_path.stat().st_size
