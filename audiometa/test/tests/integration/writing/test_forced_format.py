...
class TestForcedFormat:
    ...
    def test_forced_format_writes_only_to_specified_format(self):
        ...
        with temp_file_with_metadata(initial_metadata, "wav") as test_file_path:
            ...
            update_metadata(test_file_path, new_metadata, metadata_format=MetadataFormat.ID3V2)
    ...
    def test_forced_format_fails_fast_on_unsupported_fields(self):
        ...
        with temp_file_with_metadata(initial_metadata, "wav") as test_file_path:
            ...
            with pytest.raises(
                ...
                update_metadata(test_file_path, unsupported_metadata, metadata_format=MetadataFormat.RIFF)
    ...
    def test_forced_format_succeeds_with_supported_fields(self):
        ...
        with temp_file_with_metadata(initial_metadata, "wav") as test_file_path:
            ...
            update_metadata(test_file_path, supported_metadata, metadata_format=MetadataFormat.RIFF)

            # Verify RIFF has new metadata
            riff_metadata = get_unified_metadata(test_file_path, metadata_format=MetadataFormat.RIFF)
    ...
    def test_forced_format_id3v1_writing_support(self):
        ...
        with temp_file_with_metadata(initial_metadata, "mp3") as test_file_path:
            ...
            result = get_unified_metadata(test_file_path, metadata_format=MetadataFormat.ID3V1)
    ...
    def test_forced_format_with_rating_field(self):
        ...
        with temp_file_with_metadata(initial_metadata, "mp3") as test_file_path:
            ...
            with pytest.raises(Exception):  # ConfigurationError
                update_metadata(test_file_path, metadata_with_rating, metadata_format=MetadataFormat.ID3V2)
    ...
    def test_forced_format_with_rating_field_success(self):
        ...
        with temp_file_with_metadata(initial_metadata, "mp3") as test_file_path:
            ...
            id3v2_metadata = get_unified_metadata(test_file_path, metadata_format=MetadataFormat.ID3V2)
    ...
    def test_forced_format_validation_before_writing(self):
        ...
        with temp_file_with_metadata(initial_metadata, "wav") as test_file_path:
            ...
            with pytest.raises(
                ...
                update_metadata(test_file_path, mixed_metadata, metadata_format=MetadataFormat.RIFF)
