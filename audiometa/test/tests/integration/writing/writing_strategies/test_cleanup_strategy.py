...
class TestCleanupStrategy:
    ...
    def test_cleanup_strategy_wav(self):
        with temp_file_with_metadata({"title": "Basic Title", "artist": "Basic Artist", "album": "Basic Album"}, "wav") as test_file_path:
            ...
            update_metadata(test_file_path, metadata, metadata_strategy=MetadataWritingStrategy.CLEANUP)
    ...
    def test_cleanup_strategy_mp3_id3v1_not_preserved(self):
        ...
        with temp_file_with_metadata({}, "mp3") as test_file_path:
            ...
            update_metadata(test_file_path, id3v2_metadata, metadata_strategy=MetadataWritingStrategy.CLEANUP)
