...
class TestPreserveStrategy:
    ...
    def test_preserve_strategy_wav(self):
        with TempFileWithMetadata({"title": "ID3v2 Title", "artist": "ID3v2 Artist", "album": "ID3v2 Album"}, "wav") as test_file:
            ...
            update_metadata(test_file.path, riff_metadata, metadata_strategy=MetadataWritingStrategy.PRESERVE)
    ...
    def test_preserve_strategy_mp3_id3v1_not_preserved(self):
        with TempFileWithMetadata({}, "mp3") as test_file:
            ...
            update_metadata(test_file.path, metadata, metadata_strategy=MetadataWritingStrategy.PRESERVE)
