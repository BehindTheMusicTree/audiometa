...
class TestEncoding:
    ...
    def test_id3v2_3_encoding_support(self):
        with temp_file_with_metadata({}, "id3v2.3") as test_file_path:
            ...
            update_metadata(
                test_file_path, metadata_dict, metadata_format=MetadataFormat.ID3V2, id3v2_version=(2, 3, 0)
            )

            metadata = get_unified_metadata(test_file_path, metadata_format=MetadataFormat.ID3V2)
    ...
    def test_id3v2_4_utf8_encoding_support(self):
        with temp_file_with_metadata({}, "id3v2.4") as test_file_path:
            ...
            update_metadata(
                test_file_path, unicode_metadata, metadata_format=MetadataFormat.ID3V2, id3v2_version=(2, 4, 0)
            )
    ...
    def test_id3v1_encoding_support(self):
        with temp_file_with_metadata({}, "id3v1") as test_file_path:
            ...
            update_metadata(test_file_path, metadata_dict, metadata_format=MetadataFormat.ID3V1)
    ...
    def test_riff_utf8_encoding_support(self):
        with temp_file_with_metadata({}, "wav") as test_file_path:
            ...
            update_metadata(test_file_path, unicode_metadata, metadata_format=MetadataFormat.RIFF)
    ...
    def test_vorbis_utf8_encoding_support(self):
        with temp_file_with_metadata({}, "flac") as test_file_path:
            ...
            update_metadata(test_file_path, unicode_metadata, metadata_format=MetadataFormat.VORBIS)
