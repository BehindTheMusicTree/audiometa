...
class TestMultipleValuesVorbis:
    def test_write_multiple_artists(self):
        with temp_file_with_metadata({}, "flac") as test_file_path:
            ...
            VorbisMetadataSetter.add_title(test_file_path, "Test Song")
    ...
    def test_with_existing_artists_fields(self):
        ...
        with temp_file_with_metadata({}, "flac") as test_file_path:
            ...
            VorbisMetadataSetter.set_artists(test_file_path, ["Existing 1; Existing 2"])
            raw_metadata = VorbisMetadataGetter.get_raw_metadata(test_file_path)
    ...
    def test_with_existing_artists_fields_with_lower_case_key(self):
        ...
        with temp_file_with_metadata({}, "flac") as test_file_path:
            # create an existing value using setter
            VorbisMetadataSetter.set_artists(test_file_path, ["ExistingLower 1; ExistingLower 2"], key_lower_case=True)
            raw_output = VorbisMetadataGetter.get_raw_metadata(test_file_path)
