...
class TestSmartParsingScenarios:
    ...
    def test_scenario_1_multiple_entries_no_parsing_vorbis(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "flac") as test_file_path:
            ...
            VorbisMetadataSetter.set_artists(test_file_path, ["Artist One", "Artist; with; semicolons", "Artist Three"])
    ...
    def test_scenario_1_multiple_entries_no_parsing_riff(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "wav") as test_file_path:
            ...
            RIFFMetadataSetter.set_artists(
                test_file_path, ["Artist One", "Artist; with; semicolons", "Artist Three"], in_separate_frames=True
            )
    ...
    def test_scenario_2_single_entry_parsed_id3v2_3(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.3") as test_file_path:
            ...
            ID3v2MetadataSetter.set_artists(
                test_file_path, ["Artist One;Artist Two;Artist Three"], version="2.3", in_separate_frames=False
            )
    ...
    def test_scenario_2_single_entry_parsed_id3v2_4(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            # Set single artist entry with semicolons (legacy data in modern format)
            ID3v2MetadataSetter.set_artists(
                test_file_path, ["Artist One;Artist Two;Artist Three"], version="2.4", in_separate_frames=False
            )
    ...
    def test_scenario_2_single_entry_parsed_riff(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "wav") as test_file_path:
            ...
            RIFFMetadataSetter.set_artists(test_file_path, ["Artist One;Artist Two"], in_separate_frames=False)
            raw_metadata = RIFFMetadataGetter.get_raw_metadata(test_file_path)
