...
class TestLyricsWriting:
    def test_id3v2_3_default_en(self):
        with temp_file_with_metadata({}, "mp3") as test_file_path:
            ...
            update_metadata(
                test_file_path, test_metadata, metadata_format=MetadataFormat.ID3V2, id3v2_version=(2, 3, 0)
            )
    ...
    def test_id3v2_4_default_en(self):
        with temp_file_with_metadata({}, "mp3") as test_file_path:
            ...
            test_metadata = {UnifiedMetadataKey.UNSYNCHRONIZED_LYRICS: test_lyrics}
            update_metadata(
                test_file_path, test_metadata, metadata_format=MetadataFormat.ID3V2, id3v2_version=(2, 4, 0)
            )
