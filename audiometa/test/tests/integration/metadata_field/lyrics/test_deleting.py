...
class TestLyricsDeleting:
    ...
    def test_delete_lyrics_id3v2_3(self):
        with temp_file_with_metadata({}, "id3v2.3") as test_file_path:
            ID3v2MetadataSetter.set_lyrics(test_file_path, "Test lyrics", version="2.3")
    ...
    def test_delete_lyrics_id3v2_4(self):
        with temp_file_with_metadata({}, "id3v2.4") as test_file_path:
            ID3v2MetadataSetter.set_lyrics(test_file_path, "Test lyrics", version="2.4")
    ...
    def test_delete_lyrics_riff(self):
        with temp_file_with_metadata({}, "wav") as test_file_path:
            ...
            RIFFMetadataSetter.set_lyrics(test_file_path, "Test lyrics")
            raw_metadata = RIFFMetadataGetter.get_raw_metadata(test_file_path)
            assert "TAG:lyrics=Test lyrics" in raw_metadata

            update_metadata(
                test_file_path, {UnifiedMetadataKey.UNSYNCHRONIZED_LYRICS: None}, metadata_format=MetadataFormat.RIFF
            )
    ...
    def test_delete_lyrics_vorbis(self):
        with temp_file_with_metadata({}, "flac") as test_file_path:
            ...
            VorbisMetadataSetter.set_lyrics(test_file_path, "Test lyrics")
            raw_metadata = VorbisMetadataGetter.get_raw_metadata(test_file_path)
            assert "LYRICS=Test lyrics" in raw_metadata

            update_metadata(
                test_file_path, {UnifiedMetadataKey.UNSYNCHRONIZED_LYRICS: None}, metadata_format=MetadataFormat.VORBIS
            )
    ...
    def test_delete_lyrics_preserves_other_fields(self):
        with temp_file_with_metadata({}, "mp3") as test_file_path:
            ...
            ID3v2MetadataSetter.set_lyrics(test_file_path, "Test lyrics")
            ...
            update_metadata(
                test_file_path, {UnifiedMetadataKey.UNSYNCHRONIZED_LYRICS: None}, metadata_format=MetadataFormat.ID3V2
            )
    ...
    def test_delete_lyrics_empty_string(self):
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            ID3v2MetadataSetter.set_lyrics(test_file_path, " ")
            raw_metadata = ID3v2MetadataGetter.get_raw_metadata(test_file_path, version="2.4")
