...
class TestTitleWriting:
    def test_id3v2(self):
        ...
        with temp_file_with_metadata(test_metadata, "mp3") as test_file_path:
    ...
    def test_riff(self):
        ...
        # Use external script to set metadata instead of app's update function
        with temp_file_with_metadata(test_metadata, "wav") as test_file_path:
            # Now test that our reading logic works correctly
            title = get_unified_metadata_field(test_file_path, UnifiedMetadataKey.TITLE)
            assert title == test_title
    ...
    def test_vorbis(self):
        ...
        # Use external script to set metadata instead of app's update function
        with temp_file_with_metadata(test_metadata, "flac") as test_file_path:
            # Now test that our reading logic works correctly
            title = get_unified_metadata_field(test_file_path, UnifiedMetadataKey.TITLE)
            assert title == test_title
