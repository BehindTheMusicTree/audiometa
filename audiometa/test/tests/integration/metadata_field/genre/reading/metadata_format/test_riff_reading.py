...
class TestRiffGenreParsing:
    ...
    def test_riff_genre_mixed_codes_and_names(self):
        with temp_file_with_metadata({"title": "Test Song"}, "wav") as test_file_path:
            RIFFMetadataSetter.set_genre_text(test_file_path, "Rock; 20; Indie")
    ...
    def test_riff_genre_single_code(self):
        with temp_file_with_metadata({"title": "Test Song"}, "wav") as test_file_path:
            RIFFMetadataSetter.set_genre_text(test_file_path, "17")
    ...
    def test_riff_genre_single_name(self):
        with temp_file_with_metadata({"title": "Test Song"}, "wav") as test_file_path:
            RIFFMetadataSetter.set_genre_text(test_file_path, "Rock")
    ...
    def test_riff_genre_unknown_code(self):
        with temp_file_with_metadata({"title": "Test Song"}, "wav") as test_file_path:
            RIFFMetadataSetter.set_genre_text(test_file_path, "999")
    ...
    def test_riff_genre_very_long_text(self):
        with temp_file_with_metadata({"title": "Test Song"}, "wav") as test_file_path:
            ...
            RIFFMetadataSetter.set_genre_text(test_file_path, long_genre)
