...
class TestGenreSmartReading:
    def test_single_entry_text_with_codes_and_separators_and_without_parentheses(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            ...
            ID3v2MetadataSetter.set_genres(test_file_path, ["17/6"], version="2.4")
    ...
    def test_single_entry_codes_without_separators_vorbis(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "flac") as test_file_path:
            # Set genre with codes without separators
            VorbisMetadataSetter.set_genres(test_file_path, ["(17)(6)"])
    ...
    def test_code_text_then_text_part_even_if_different(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            ...
            ID3v2MetadataSetter.set_genres(test_file_path, ["(17)Rock"], version="2.4")
    ...
    def test_single_entry_code_text_without_separators(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            ...
            ID3v2MetadataSetter.set_genres(test_file_path, ["(17)Rock(6)Blues"], version="2.4")
    ...
    def test_one_code_and_one_code_text_in_single_entry(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            ...
            ID3v2MetadataSetter.set_genres(test_file_path, ["(17)(6)Grunge"], version="2.4")
    ...
    def test_one_code_and_one_code_text_in_multi_entries(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            # Set genre with one code and one code+text
            ID3v2MetadataSetter.set_genres(
                test_file_path, ["(17)", "(6)Grunge"], in_separate_frames=True, version="2.4"
            )
            raw_metadata = ID3v2MetadataGetter.get_raw_metadata(test_file_path)
    ...
    def test_single_entry_text_with_slash_separators(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            ...
            ID3v2MetadataSetter.set_genres(test_file_path, ["Rock/Blues"], version="2.4")
    ...
    def test_single_entry_text_with_semicolon_separators(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            # Set genre with text with separators
            ID3v2MetadataSetter.set_genres(test_file_path, ["Rock; Alternative"], version="2.4")
    ...
    def test_multiple_entries_return_as_is(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            ...
            ID3v2MetadataSetter.set_genres(
                test_file_path, ["Rock/Grunge", "Blues"], in_separate_frames=True, version="2.4"
            )
    ...
    def test_code_to_name_conversion_with_unknown_code(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            ...
            ID3v2MetadataSetter.set_genres(test_file_path, ["(17)", "(999)"], version="2.4")
    ...
    def test_code_text_uses_text_part(self):
        ...
        with temp_file_with_metadata({"title": "Test Song"}, "id3v2.4") as test_file_path:
            # Set genre with code+text
            ID3v2MetadataSetter.set_genres(test_file_path, ["(199)Rock"], version="2.4")
