...
class TestComprehensiveRatingWriting:
    def test_write_read_with_different_max_values(self):
        ...
        with temp_file_with_metadata(basic_metadata, "mp3") as test_file_path:
            ...
            update_metadata(
                test_file_path, test_metadata, normalized_rating_max_value=100, metadata_format=MetadataFormat.ID3V2
            )
            ...
            rating_255 = get_unified_metadata_field(
                test_file_path, UnifiedMetadataKey.RATING, normalized_rating_max_value=255
            )
    ...
    def test_cross_metadata_format_rating_consistency(self):
        ...
        with temp_file_with_metadata(basic_metadata, "wav") as test_file_path:
            test_metadata = {UnifiedMetadataKey.RATING: test_rating}
            update_metadata(
                test_file_path, test_metadata, normalized_rating_max_value=100, metadata_format=MetadataFormat.RIFF
            )
            rating = get_unified_metadata_field(
                test_file_path, UnifiedMetadataKey.RATING, normalized_rating_max_value=100
            )
    ...
    def test_metadata_format_specific_rating_profiles(self):
        ...
        with temp_file_with_metadata(basic_metadata, "mp3") as test_file_path:
            ...
            for value in test_values:
                ...
                update_metadata(
                    test_file_path, test_metadata, normalized_rating_max_value=255, metadata_format=MetadataFormat.ID3V2
                )
                rating = get_unified_metadata_field(
                    test_file_path, UnifiedMetadataKey.RATING, normalized_rating_max_value=255
                )
    ...
    def test_rating_removal_consistency_across_formats(self):
        ...
        for format_type, file_ext in [
            ...
            with temp_file_with_metadata(basic_metadata, file_ext) as test_file_path:
                # First write a rating
                test_metadata = {UnifiedMetadataKey.RATING: 80}
                update_metadata(
                    test_file_path, test_metadata, normalized_rating_max_value=100, metadata_format=format_type
                )
                rating = get_unified_metadata_field(
                    test_file_path, UnifiedMetadataKey.RATING, normalized_rating_max_value=100
                )
