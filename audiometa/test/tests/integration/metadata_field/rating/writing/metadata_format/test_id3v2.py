...
class TestId3v2RatingWriting:
    ...
    def test_write_star_rating(self, star_rating, expected_normalized_rating):
        ...
        with temp_file_with_metadata(basic_metadata, "mp3") as test_file_path:
            ...
            update_metadata(test_file_path, test_metadata, normalized_rating_max_value=100, metadata_format=MetadataFormat.ID3V2)
    ...
    def test_write_base_255_non_proportional_values(self):
        ...
        with temp_file_with_metadata(basic_metadata, "mp3") as test_file_path:
            for value in test_values:
                ...
                update_metadata(test_file_path, test_metadata, normalized_rating_max_value=255, metadata_format=MetadataFormat.ID3V2)
                rating = get_unified_metadata_field(test_file_path, UnifiedMetadataKey.RATING, normalized_rating_max_value=255)
                assert rating is not None
