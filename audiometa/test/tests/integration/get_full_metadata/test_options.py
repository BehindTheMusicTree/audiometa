...
class TestGetFullMetadataOptions:
    ...
    def test_get_full_metadata_with_audiofile_object_exclude_options(self, sample_mp3_file: Path):
        from audiometa import AudioFile

        audio_file = AudioFile(sample_mp3_file)
        result = get_full_metadata(audio_file, include_headers=False, include_technical=False)
