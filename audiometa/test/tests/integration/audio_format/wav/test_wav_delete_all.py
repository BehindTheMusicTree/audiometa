...
class TestDeleteAllMetadataFormatSpecificWAV:
    ...
    def test_riff(self):
        with temp_file_with_metadata(
            {"title": "Test RIFF Title", "artist": "Test RIFF Artist"}, "wav"
        ) as test_file_path:
            ...
            result = delete_all_metadata(test_file_path, metadata_format=MetadataFormat.RIFF)
            assert result is True
    ...
    def test_vorbis(self):
        with temp_file_with_metadata(
            ...
            with pytest.raises(MetadataFormatNotSupportedByAudioFormatError):
                delete_all_metadata(test_file_path, metadata_format=MetadataFormat.VORBIS)
