...
class TestWavWithId3v2Tags:
    ...
    def test_wav_with_id3v2_tags_audiofile_instantiation(self):
        ...
        with TempFileWithMetadata({}, "wav") as test_file:
            ...
            audio_file = AudioFile(test_file.path)  # Should not raise FileCorruptedError
    ...
    def test_wav_with_id3v2_tags_validation_and_reading(self):
        ...
        with TempFileWithMetadata({
            ...
            initial_metadata = get_unified_metadata(test_file.path)
            ...
            id3v2_title = ID3v2MetadataGetter.get_title(test_file.path)
            riff_title = RIFFMetadataGetter.get_title(test_file.path)
