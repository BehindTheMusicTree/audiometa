...
from ..rating_supporting._RatingSupportingMetadataManager import _RatingSupportingMetadataManager
...
class _RiffManager(_RatingSupportingMetadataManager):
    ...
    def _update_not_using_mutagen_metadata(self, unified_metadata: UnifiedMetadata) -> None:
        """Update metadata fields in the RIFF INFO chunk using an optimized chunk-based approach. This implementation
